function scr_pizzaface_init_sounds() //gml_Script_scr_pizzaface_init_sounds
{
...
function scr_pizzaface_destroy_sounds() //gml_Script_scr_pizzaface_destroy_sounds
{
...
function scr_pizzaface_arenaintro() //gml_Script_scr_pizzaface_arenaintro
{
    if (!skipintro)
    {
        image_speed = 0.35
...
function scr_pizzaface_normal() //gml_Script_scr_pizzaface_normal
{
    if lasthit
    {
        elitehit = 0
...
function scr_pizzaface_ram() //gml_Script_scr_pizzaface_ram
{
    switch substate
    {
        case (144 << 0):
...
function scr_pizzaface_transitioncutscene() //gml_Script_scr_pizzaface_transitioncutscene
{
    image_speed = 0.35
    image_alpha = 1
    alarm[6] = -1
