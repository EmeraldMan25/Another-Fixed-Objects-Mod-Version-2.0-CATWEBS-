function vigilante_start_attack(argument0, argument1) //gml_Script_vigilante_start_attack
{
    attack_list[argument0][argument1] = array_create(0)
}

function vigilante_add_attack(argument0, argument1, argument2, argument3) //gml_Script_vigilante_add_attack
{
...
function vigilante_end_attack(argument0, argument1) //gml_Script_vigilante_end_attack
{
    var found = false
    var i = 0
    while ((i < array_length(attack_list[argument0][argument1])))
    {
...
function scr_vigilante_init_sounds() //gml_Script_scr_vigilante_init_sounds
{
...
function scr_vigilante_destroy_sounds() //gml_Script_scr_vigilante_destroy_sounds
{
    destroy_sounds([snd_flame, snd_mach1, snd_slide, snd_uziprep])
}

function scr_vigilante_update_sounds() //gml_Script_scr_vigilante_update_sounds
{
    ...
    if ((state == (104 << 0)) && (sprite_index != spr_playerV_crouchmove))
    {
...
function scr_vigilante_arenaintro() //gml_Script_scr_vigilante_arenaintro
{
...
function scr_vigilante_do_hurt_phase2(argument0) //gml_Script_scr_vigilante_do_hurt_phase2
{
    scr_boss_do_hurt_phase2(argument0)
}

function scr_vigilante_phase1hurt() //gml_Script_scr_vigilante_phase1hurt
{
...
function scr_vigilante_do_cow(argument0, argument1) //gml_Script_scr_vigilante_do_cow
{
...
function scr_vigilante_throw_cow() //gml_Script_scr_vigilante_throw_cow
{
    if ((shot > 0))
    {
        shot--
...
function scr_vigilante_do_revolver(argument0, argument1, argument2) //gml_Script_scr_vigilante_do_revolver
{
    ...
    if jump
    {
        ...
        vsp = -9
        sprite_index = spr_playerV_jump
        tauntstoredstate = (1 << 0)
    }
}

function scr_vigilante_do_dynamite(argument0) //gml_Script_scr_vigilante_do_dynamite
{
    shot = argument0
    state = (2 << 0)
...
function scr_vigilante_throw_dynamite() //gml_Script_scr_vigilante_throw_dynamite
{
    if ((shot > 0))
    {
...
function scr_vigilante_wait() //gml_Script_scr_vigilante_wait
{
    hsp = Approach(hsp, 0, 1)
    if ((sprite_index == spr_playerV_revolverend))
        sprite_index = spr_playerV_revolverhold
...
function scr_vigilante_estampede() //gml_Script_scr_vigilante_estampede
{
    hsp = 0
    image_speed = 0.35
...
function scr_vigilante_do_reload(argument0) //gml_Script_scr_vigilante_do_reload
{
    if ((argument0 == undefined))
        argument0 = 360
    state = (269 << 0)
...
function scr_vigilante_reloading() //gml_Script_scr_vigilante_reloading
{
    image_speed = 0.35
    hsp = Approach(hsp, 0, 1)
    if ((reloadbuffer > 0))
...
function scr_vigilante_mach2() //gml_Script_scr_vigilante_mach2
{
    image_speed = 0.35
...
function scr_vigilante_check_spot() //gml_Script_scr_vigilante_check_spot
{
...
function scr_vigilante_crouchslide() //gml_Script_scr_vigilante_crouchslide
{
    hsp = (image_xscale * attackspeed)
    if ((attackspeed > 0))
        attackspeed -= 0.15
...
function scr_vigilante_duel() //gml_Script_scr_vigilante_duel
{
...
function scr_vigilante_punch() //gml_Script_scr_vigilante_punch
{
    image_speed = 0.35
    if ((floor(image_index) == (image_number - 1)))
    {
...
function scr_vigilante_flamethrower() //gml_Script_scr_vigilante_flamethrower
{
...
function scr_vigilante_machinegun() //gml_Script_scr_vigilante_machinegun
{
    if ((sprite_index == spr_vigilante_uziprepare))
    {
        hsp = 0
...
function scr_vigilante_bazooka() //gml_Script_scr_vigilante_bazooka
{
...
function scr_vigilante_crate() //gml_Script_scr_vigilante_crate
{
...
function scr_vigilante_hit() //gml_Script_scr_vigilante_hit
{
    if (!pizzahead)
    {
