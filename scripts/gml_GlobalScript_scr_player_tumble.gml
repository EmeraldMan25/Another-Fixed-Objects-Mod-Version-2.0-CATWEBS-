function scr_player_tumble() //gml_Script_scr_player_tumble
{
    ...
    if ((crouchslipbuffer > 0))
        crouchslipbuffer--
    if ((!key_down) && key_attack && grounded && (state != (106 << 0)) && (sprite_index != spr_tumblestart) && (sprite_index != spr_tumble) && (sprite_index != spr_tumbleend) && (!(scr_solid(x, (y - 16)))) && (!(scr_solid(x, (y - 32)))) && (sprite_index != spr_breakdance))
    {
        if ((crouchslipbuffer == 0))
        {
    ...
    if ((!key_down) && (!key_attack) && grounded && (vsp > 0) && (state != (106 << 0)) && (sprite_index != spr_tumblestart) && (sprite_index != spr_tumble) && (sprite_index != spr_tumbleend) && (!(scr_solid(x, (y - 16)))) && (!(scr_solid(x, (y - 32)))) && (sprite_index != spr_breakdance))
    {
        if ((crouchslipbuffer == 0))
        {
            if ((movespeed > 6))
