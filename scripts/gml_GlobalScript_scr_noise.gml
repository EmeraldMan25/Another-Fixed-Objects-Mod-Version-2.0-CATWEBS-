function scr_noise_init_sounds() //gml_Script_scr_noise_init_sounds
{
...
function scr_noise_destroy_sounds() //gml_Script_scr_noise_destroy_sounds
{
...
function scr_noise_update_sounds() //gml_Script_scr_noise_update_sounds
{
    if ((state == (244 << 0)))
    {
...
function scr_noise_arenaintro() //gml_Script_scr_noise_arenaintro
{
...
function scr_doise_end_start() //gml_Script_scr_doise_end_start
{
...
function scr_noise_do_hurt(argument0) //gml_Script_scr_noise_do_hurt
{
    if ((state != (138 << 0)))
    {
        if ((x != argument0.x))
...
function scr_noise_mach2() //gml_Script_scr_noise_mach2
{
...
function scr_noise_machslide() //gml_Script_scr_noise_machslide
{
    hsp = (image_xscale * attackspeed)
    if ((attackspeed > 0))
        attackspeed -= 0.2
...
function scr_noise_spin() //gml_Script_scr_noise_spin
{
    if ((image_index > 2))
        hsp = (image_xscale * 2)
...
function scr_noise_jetpackstart() //gml_Script_scr_noise_jetpackstart
{
    hsp = 0
    vsp = 0
    if ((floor(image_index) == (image_number - 1)))
...
function scr_noise_jetpack() //gml_Script_scr_noise_jetpack
{
...
function scr_noise_bounce() //gml_Script_scr_noise_bounce
{
    image_speed = 0.35
    hsp = (image_xscale * 10)
...
function scr_noise_pogo() //gml_Script_scr_noise_pogo
{
    if (!bounced)
        hsp = 0
    else
...
function scr_noise_dropstart() //gml_Script_scr_noise_dropstart
{
    hsp = 0
...
function scr_noise_drop() //gml_Script_scr_noise_drop
{
    image_speed = 0.35
...
function scr_noise_droptrap() //gml_Script_scr_noise_droptrap
{
    droptrap = false
    hsp = 0
    if ((floor(image_index) == (image_number - 1)))
...
function scr_noise_freefall() //gml_Script_scr_noise_freefall
{
    image_speed = 0.35
    hsp = 0
...
function scr_noise_golf() //gml_Script_scr_noise_golf
{
    hsp = 0
    if ((floor(image_index) == (image_number - 1)))
    {
...
function scr_noise_noisecrusher() //gml_Script_scr_noise_noisecrusher
{
    hsp = 0
...
function scr_noise_noiseballooncrash() //gml_Script_scr_noise_noiseballooncrash
{
    hsp = 0
    with (obj_player1)
    {
...
function scr_noise_fightball() //gml_Script_scr_noise_fightball
{
    switch substate
    {
        case (295 << 0):
...
function scr_noise_finale() //gml_Script_scr_noise_finale
{
    with (obj_player1)
    {
...
function scr_noise_phase1hurt() //gml_Script_scr_noise_phase1hurt
{
    sprite_index = spr_playerN_hurt
    image_index = 0.35
    scr_boss_phase1hurt(function() //gml_Script_anon_scr_noise_phase1hurt_gml_GlobalScript_scr_noise_37444_scr_noise_phase1hurt_gml_GlobalScript_scr_noise
    {
