function get_buffer_group_name() //gml_Script_get_buffer_group_name
{
    return "saves";
}

function get_save_folder() //gml_Script_get_save_folder
{
    return "saves";
}

function get_percentage() //gml_Script_get_percentage
{
...
function gamesave_async_save_options() //gml_Script_gamesave_async_save_options
{
    with (obj_savesystem)
    {
        dirty = true
