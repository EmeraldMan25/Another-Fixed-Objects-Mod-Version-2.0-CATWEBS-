...
function scr_playerreset(argument0) //gml_Script_scr_playerreset
{
    ...
    if (!global.levelreset)
    {
        ...
        global.countedsecrets = 0
        global.secretscounted = 0
        global.insecret = 0
        global.countedrooms = 0
