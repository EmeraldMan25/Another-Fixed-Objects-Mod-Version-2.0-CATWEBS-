function scr_pizzaface_p2_init_sounds() //gml_Script_scr_pizzaface_p2_init_sounds
{
...
function scr_pizzaface_p2_destroy_sounds() //gml_Script_scr_pizzaface_p2_destroy_sounds
{
    destroy_sounds([snd_haywire, snd_tvthrow, snd_spin, snd_grablevel, snd_fishing, snd_ratball])
}

function scr_pizzaface_p2_update_sounds() //gml_Script_scr_pizzaface_p2_update_sounds
{
...
function scr_pizzaface_p2_fall() //gml_Script_scr_pizzaface_p2_fall
{
    image_speed = 0.35
    hsp = 0
    with (obj_player1)
...
function scr_pizzaface_p2_normal() //gml_Script_scr_pizzaface_p2_normal
{
    if ((elitehit <= 0))
    {
        destroyable = true
...
function scr_pizzaface_p2_look() //gml_Script_scr_pizzaface_p2_look
{
    hsp = 0
    if ((fishingbuffer > 0))
        fishingbuffer--
...
function scr_pizzaface_p2_fishing() //gml_Script_scr_pizzaface_p2_fishing
{
    hsp = 0
...
function boss_pizzahead_pinup() //gml_Script_boss_pizzahead_pinup
{
    hsp = 0
    if ((floor(image_index) == (image_number - 1)))
    {
...
function boss_pizzahead_portraitthrow() //gml_Script_boss_pizzahead_portraitthrow
{
...
function boss_pizzahead_pullinglevel() //gml_Script_boss_pizzahead_pullinglevel
{
...
function boss_pizzahead_throwing() //gml_Script_boss_pizzahead_throwing
{
    hsp = 0
    if (!brick)
    {
...
function boss_pizzahead_shotgun() //gml_Script_boss_pizzahead_shotgun
{
    switch substate
    {
        case (268 << 0):
...
function boss_pizzahead_p2_phase1hurt() //gml_Script_boss_pizzahead_p2_phase1hurt
{
