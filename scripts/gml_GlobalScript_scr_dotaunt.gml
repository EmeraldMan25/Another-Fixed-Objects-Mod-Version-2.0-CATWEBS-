function scr_dotaunt() //gml_Script_scr_dotaunt
{
    if ((key_taunt2 || (input_finisher_buffer > 0) || ((state == (84 << 0)) && key_up && supercharged)) && (!skateboarding))
    {
        ...
        {
            taunttimer = 20
            if ((state != (84 << 0)) && (sprite_index != spr_supertaunt1) && (sprite_index != spr_supertaunt2) && (sprite_index != spr_supertaunt3) && (sprite_index != spr_supertaunt4) && (sprite_index != spr_player_ratmountsupertaunt))
            {
