function scr_enemy_grabbed() //gml_Script_scr_enemy_grabbed
{
    if (!pepperman_grab)
    {
        ...
        if ((_obj_player.state == (55 << 0)) || (_obj_player.state == (79 << 0)) || (_obj_player.state == (74 << 0)) || (_obj_player.state == (75 << 0)) || (_obj_player.state == (20 << 0)))
        {
            x = _obj_player.x
        ...
        with (_obj_player)
        {
            ...
            if (!(((state == (79 << 0)) || (state == (61 << 0)) || (state == (154 << 0)) || (state == (6 << 0)) || (state == (55 << 0)) || (state == (74 << 0)) || (state == (75 << 0)) || (state == (20 << 0)) || (state == (80 << 0)) || (state == (76 << 0)) || (state == (81 << 0)) || (state == (82 << 0)) || (state == (83 << 0)))))
            {
                other.x = x
                other.y = y
                other.state = (138 << 0)
        ...
        hsp = 0
        if ((_obj_player.state == (80 << 0)) || (_obj_player.state == (147 << 0)))
        {
            alarm[3] = 3
            global.hit += 1
        ...
        if ((_obj_player.state == (6 << 0)) && ((floor(_obj_player.image_index) >= 4) || ((floor(_obj_player.image_index) < 1) && (_obj_player.sprite_index == _obj_player.spr_swingdingend))))
        {
            thrown = true
            if heavy
                var lag = 15
        ...
        if ((_obj_player.state == (76 << 0)) || ((_obj_player.state == (61 << 0)) && (sprite_index == spr_player_piledriver)))
        {
        ...
        if ((state != (4 << 0)) || (_obj_player.state != (79 << 0)))
        {
            check_grabbed_solid(_obj_player)
            if ((state == (137 << 0)))
            {
