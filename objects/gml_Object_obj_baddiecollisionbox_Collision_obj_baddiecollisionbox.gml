if (instance_exists(baddieID) && instance_exists(other.baddieID) && (baddieID.object_index != obj_pizzafaceboss) && (!baddieID.thrown) && (!other.baddieID.mach3destroy) && (baddieID.state != (137 << 0)) && other.baddieID.thrown && (other.baddieID.state != (137 << 0)) && (baddieID.killbyenemybuffer <= 0) && baddieID.killbyenemy && (baddieID != other.baddieID) && (baddieID.state != (4 << 0)) && (!baddieID.invincible) && baddieID.instantkillable && (((global.attackstyle != 2) && (!global.kungfu)) || (baddieID.hp <= 0)) && (!global.kungfu))
{
