...
switch state
{
    ...
    case (0 << 0):
        ...
        switch super_portrait_state
        {
            ...
            case 2:
                super_portrait_index += 0.35
                super_portrait_x += 1
                if ((obj_player.state != (252 << 0)) || (obj_player.superattackstate != (8 << 0)))
    ...
    case (8 << 0):
        ...
        if ((player_hp > 0))
        {
            if ((!instance_exists(bossID)) || (bossID.state != (137 << 0)))
            {
                fade -= 0.05
                fade = clamp(fade, 0, 1)
            }
...
{
    if ((obj_player1.state == (137 << 0)) || (obj_player1.state == (156 << 0)))
        portrait1_sprite = portrait1_hurt
    else
        portrait1_sprite = portrait1_idle
    if ((bossID.state == (137 << 0)) || (bossID.state == (138 << 0)))
